          ...
          <div className="activity-form">
            <div className="form-section">
              ...
              <div className="form-row">
                ...
                <input 
                  type="text"
                  value={activityData.broadActivityArea}
                  onChange={(e) => handleInputChange('broadActivityArea', e.target.value)}
                />
              </div>
              ...
              <div className="form-row">
                ...
                <div className="priority-slider">
                  ...
                  />
                  <span>10</span>
                  <div className="priority-value">{activityData.priority}</div>
                </div>
              </div>
