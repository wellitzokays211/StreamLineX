      ...
      <div className="main-content">
        ...
        <div className="content">
          ...
          <div className="card">
            ...
            <div className="form-group">
              <label className="form-label">Broad Activity Area</label>
              <input 
                className="form-input" 
                value="Construct School Buildings" 
                readOnly 
              />
            </div>
            
            <div className="form-group">
              <label className="form-label">Sub Component</label>
              <input 
                className="form-input" 
                value="Strengthening education administration and management at provincial, and zonal levels" 
                readOnly 
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input 
                className="form-input" 
                value="Strengthen towards education governance and service delivery of education" 
                readOnly 
              />
            </div>
